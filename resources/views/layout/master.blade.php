    ...
    <div class="container-scroller">
        ...
        <nav class="navbar default-layout-navbar col-lg-12 col-12 p-0 fixed-top d-flex flex-row  d-print-none">
            <div class="text-center navbar-brand-wrapper d-flex align-items-center justify-content-center">
                <a class="navbar-brand brand-logo" href="index.html"><img src="{{ asset('assets/images/denso.png') }}"
                        alt="logo" /></a>
                        ...
                        <a class="nav-link dropdown-toggle" id="profileDropdown" href="#"
                            ...
                            <div class="nav-profile-img">
                                @if (auth()->user()->akses_user == 'karyawan')
                                    <img src="{{ Avatar::create(auth()->user()->karyawans->nama)->toBase64() }}"
                                        alt="image">
                                    <span class="availability-status online"></span>
                                @elseif(auth()->user()->akses_user == 'atasan')
                                    <img src="{{ Avatar::create(auth()->user()->atasans->nama)->toBase64() }}"
                                        alt="image">
                                    <span class="availability-status online"></span>
                            ...
                            <div class="nav-profile-text">
                                @if (auth()->user()->akses_user == 'karyawan')
                                    <p class="mb-1 text-black">{{ auth()->user()->karyawans->nama }}</p>
                                @elseif(auth()->user()->akses_user == 'atasan')
                                    <p class="mb-1 text-black">{{ auth()->user()->atasans->nama }}</p>
                                @endif
                ...
                <footer class="footer d-print-none">
                    <div class="container-fluid d-flex justify-content-between">
                        ...
                        {{-- <span class="float-none float-sm-end mt-1 mt-sm-0 text-end"> Free <a
                                href="https://www.bootstrap.com/" target="_blank">Bootstrap
                                admin template</a> from Bootstrap.com</span> --}}
                    </div>
                </footer>
                <!-- partial -->
            </div>
