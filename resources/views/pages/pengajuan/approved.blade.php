    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                @if (auth()->user()->akses_user == 'atasan' || auth()->user()->akses_user == 'karyawan')
                    <div class="row justify-content-between">
                        ...
                        <div class="col-md-6 d-print-none text-right">
                            <div class="row justify-content-end">
                                <div class="col-6">
                                    <form action="{{ url('periode-approved') }}" method="POST" autocomplete="off">
                                        @csrf
                            ...
                            <tr>
                                ...
                                <td class="d-print-none">
                                    ...
                                    @if (auth()->user()->akses_user == 'atasan')
                                        <a href="{{ url('nilai-pengajuan/' . $dt->id) }}"
